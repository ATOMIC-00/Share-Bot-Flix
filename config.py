...
#start message
START_MSG = os.environ.get("START_MESSAGE", "<b>🌟 ʜᴇʟʟᴏ! {first}\n\nɪ ᴄᴀɴ ꜱᴛᴏʀᴇ ᴘʀɪᴠᴀᴛᴇ ꜰɪʟᴇꜱ ɪɴ ᴀ ꜱᴘᴇᴄɪꜰɪᴇᴅ ᴄʜᴀɴɴᴇʟ 📁, ᴀɴᴅ ᴏᴛʜᴇʀ ᴜꜱᴇʀꜱ ᴄᴀɴ ᴀᴄᴄᴇꜱꜱ ᴛʜᴇᴍ ꜰʀᴏᴍ ᴀ ꜱᴘᴇᴄɪᴀʟ ʟɪɴᴋ 🔗</b>")
try:
    ADMINS=[]
...
#Force sub message 
FORCE_MSG = os.environ.get("FORCE_SUB_MESSAGE", "🌟 ʜᴇʟʟᴏ! {first}\n\n<b>ᴛᴏ ᴜɴʟᴏᴄᴋ ᴀʟʟ ᴍʏ ꜰᴇᴀᴛᴜʀᴇꜱ ᴀɴᴅ ʙᴇɴᴇꜰɪᴛꜱ, ʏᴏᴜ ɴᴇᴇᴅ ᴛᴏ ᴊᴏɪɴ ᴍʏ ᴄʜᴀɴɴᴇʟ/ɢʀᴏᴜᴘ!\n\n👉 ᴋɪɴᴅʟʏ ᴊᴏɪɴ ᴛʜᴇ ᴄʜᴀɴɴᴇʟ ᴛᴏ ɢᴇᴛ ꜱᴛᴀʀᴛᴇᴅ!</b>")
